...
CKEDITOR.lang["id"] = {
  ...
  about: { copy: "Hak cipta &copy; $1. All rights reserved.", dlgTitle: "Tentang CKEditor 4", moreInfo: "Untuk informasi lisensi silahkan kunjungi web site kami:" },
  basicstyles: { bold: "Huruf Tebal", italic: "Huruf Miring", strike: "Strikethrough", subscript: "Subscript", superscript: "Superscript", underline: "Garis Bawah" },
  bidi: { ltr: "Arah penulisan dari kiri ke kanan.", rtl: "Arah penulisan dari kanan ke kiri." },
  ...
  colordialog: { clear: "Hapus", highlight: "Sorot", options: "Pilihan Warna", selected: "Warna Dipilih", title: "Pilih Warna" },
  templates: { button: "Contoh", emptyListMsg: "(Tidak ada contoh didefinisikan)", insertOption: "Ganti konten sebenarnya", options: "Opsi Contoh", selectPromptMsg: "Mohon pilih contoh untuk dibuka di editor", title: "Contoh Konten" },
  contextmenu: { options: "Opsi Konteks Pilihan" },
  copyformatting: { label: "Copy Formatting", notification: { copied: "Formatting copied", applied: "Formatting applied", canceled: "Formatting canceled", failed: "Formatting failed. You cannot apply styles without copying them first." } },
  div: {
    IdInputLabel: "Id",
  ...
  fakeobjects: { anchor: "Anchor", flash: "Animasi Flash", hiddenfield: "Kolom Tersembunyi", iframe: "IFrame", unknown: "Obyek Tak Dikenal" },
  flash: {
  ...
  font: { fontSize: { label: "Ukuran", voiceLabel: "Ukuran Huruf", panelTitle: "Ukuran Huruf" }, label: "Huruf", panelTitle: "Font Name", voiceLabel: "Huruf" },
  forms: {
    button: { title: "Properti Tombol", text: "Teks (Nilai)", type: "Tipe", typeBtn: "Tombol", typeSbm: "Menyerahkan", typeRst: "Atur Ulang" },
    checkboxAndRadio: { checkboxTitle: "Checkbox Properties", radioTitle: "Radio Button Properties", value: "Nilai", selected: "Terpilih", required: "Wajib" },
    form: { title: "Form Properties", menu: "Form Properties", action: "Aksi", method: "Metode", encoding: "Encoding" },
  ...
  iframe: { border: "Tampilkan Batas Bingkai", noUrl: "Please type the iframe URL", scrolling: "Aktifkan Scrollbar", title: "IFrame Properties", toolbar: "IFrame" },
  image: {
    alt: "Teks alternatif",
    border: "Batas",
  ...
  smiley: { options: "Opsi Smiley", title: "Sisip sebuah Smiley", toolbar: "Smiley" },
  ...
  link: {
    ...
    advisoryTitle: "Penasehat Judul",
    anchor: { toolbar: "Anchor", menu: "Edit Anchor", title: "Anchor Properties", name: "Anchor Name", errorName: "Please type the anchor name", remove: "Remove Anchor" },
  ...
  list: { bulletedlist: "Sisip/Hapus Daftar Bullet", numberedlist: "Sisip/Hapus Daftar Bernomor" },
  liststyle: {
  ...
  pagebreak: { alt: "Halaman Istirahat", toolbar: "Sisip Halaman Istirahat untuk Pencetakan " },
  pastetext: { button: "Tempel sebagai teks polos", pasteNotification: "Press %1 to paste. Your browser doesn‘t support pasting with the toolbar button or context menu option.", title: "Tempel sebagai Teks Polos" },
  pastefromword: {
  ...
  specialchar: { options: "Opsi spesial karakter", title: "Pilih spesial karakter", toolbar: "Sisipkan spesial karakter" },
  scayt: { btn_about: "About SCAYT", btn_dictionaries: "Dictionaries", btn_disable: "Disable SCAYT", btn_enable: "Enable SCAYT", btn_langs: "Languages", btn_options: "Options", text_title: "Spell Check As You Type" },
  stylescombo: { label: "Gaya", panelTitle: "Formatting Styles", panelTitle1: "Block Styles", panelTitle2: "Inline Styles", panelTitle3: "Object Styles" },
  table: {
    border: "Ukuran batas",
    ...
    column: { menu: "Kolom", insertBefore: "Sisip Kolom Sebelum", insertAfter: "Sisip Kolom Sesudah", deleteColumn: "Hapus Kolom" },
    columns: "Kolom",
    ...
    menu: "Properti Tabel",
    row: { menu: "Baris", insertBefore: "Sisip Baris Sebelum", insertAfter: "Sisip Baris Sesudah", deleteRow: "Hapus Baris" },
    rows: "Baris",
    summary: "Intisari",
