      ...
      z = function () {
        ...
        b.lockRatio &&
          ...
          "true" == c.getCustomData("isReady") &&
            ("txtHeight" == this.id
              ? (a && "0" != a && (a = Math.round((a / c.$.height) * c.$.width)), isNaN(a) || b.setValueOf("info", "txtWidth", a))
              : (a && "0" != a && (a = Math.round((a / c.$.width) * c.$.height)), isNaN(a) || b.setValueOf("info", "txtHeight", a))));
        e(b);
      },
      e = function (a) {
        ...
        c &&
          ...
          1 == a.count() &&
            ...
            d.type == CKEDITOR.NODE_ELEMENT &&
              (d.is("img") || d.is("input")) &&
              ((this.imageElement = a.getItem(0)), this.imageElement.is("img") ? (this.imageEditMode = "img") : this.imageElement.is("input") && (this.imageEditMode = "input"))),
      ...
      onOk: function () {
        if (this.imageEditMode) {
          ...
          "image" == k && "input" == a && confirm(d.lang.image.button2Img)
            ? ((this.imageElement = d.document.createElement("img")), this.imageElement.setAttribute("alt", ""), d.insertElement(this.imageElement))
            : "image" != k && "img" == a && confirm(d.lang.image.img2Button)
            ? ((this.imageElement = d.document.createElement("input")), this.imageElement.setAttributes({ type: "image", alt: "" }), d.insertElement(this.imageElement))
        ...
        this.imageEditMode
          ? !this.linkEditMode && this.addLink
            ? (d.insertElement(this.linkElement), this.imageElement.appendTo(this.linkElement))
            : this.linkEditMode && !this.addLink && (d.getSelection().selectElement(this.linkElement), d.insertElement(this.imageElement))
          : this.addLink
          ? this.linkEditMode
            ? this.linkElement.equals(d.getSelection().getSelectedElement())
              ? (this.linkElement.setHtml(""), this.linkElement.append(this.imageElement, !1))
              : d.insertElement(this.imageElement)
            : (d.insertElement(this.linkElement), this.linkElement.append(this.imageElement, !1))
          : d.insertElement(this.imageElement);
      },
      onLoad: function () {
      ...
      contents: [
                          ...
                          children: [
                            {
                              ...
                              commit: function (a, b) {
                                var c = this.getValue();
                                1 == a
                                  ? (c && d.activeFilter.check("img{width,height}") ? b.setStyle("width", CKEDITOR.tools.cssLength(c)) : b.removeStyle("width"), b.removeAttribute("width"))
                                  : 4 == a
                                  ? c.match(l)
                                    ? b.setStyle("width", CKEDITOR.tools.cssLength(c))
                                    : ((c = this.getDialog().originalElement), "true" == c.getCustomData("isReady") && b.setStyle("width", c.$.width + "px"))
                            ...
                            },
                            {
                              ...
                              commit: function (a, b) {
                                var c = this.getValue();
                                1 == a
                                  ? (c && d.activeFilter.check("img{width,height}") ? b.setStyle("height", CKEDITOR.tools.cssLength(c)) : b.removeStyle("height"), b.removeAttribute("height"))
                                  : 4 == a
                                  ? c.match(l)
                                    ? b.setStyle("height", CKEDITOR.tools.cssLength(c))
                                    : ((c = this.getDialog().originalElement), "true" == c.getCustomData("isReady") && b.setStyle("height", c.$.height + "px"))
                      ...
                      children: [
                        {
                          ...
                          commit: function (a, b) {
                            ...
                            1 == a || 4 == a
                              ? (isNaN(c) ? !c && this.isChanged() && b.removeStyle("border") : (b.setStyle("border-width", CKEDITOR.tools.cssLength(c)), b.setStyle("border-style", "solid")), 1 == a && b.removeAttribute("border"))
                              : 8 == a && (b.removeAttribute("border"), b.removeStyle("border-width"), b.removeStyle("border-style"), b.removeStyle("border-color"));
                          },
                        },
                        {
                          type: "text",
                          ...
                          commit: function (a, b) {
                            ...
                            1 == a || 4 == a
                              ? (isNaN(c)
                                  ? !c && this.isChanged() && (b.removeStyle("margin-left"), b.removeStyle("margin-right"))
                                  : (b.setStyle("margin-left", CKEDITOR.tools.cssLength(c)), b.setStyle("margin-right", CKEDITOR.tools.cssLength(c))),
                        ...
                        },
                        {
                          ...
                          commit: function (a, b) {
                            ...
                            1 == a || 4 == a
                              ? (isNaN(c)
                                  ? !c && this.isChanged() && (b.removeStyle("margin-top"), b.removeStyle("margin-bottom"))
                                  : (b.setStyle("margin-top", CKEDITOR.tools.cssLength(c)), b.setStyle("margin-bottom", CKEDITOR.tools.cssLength(c))),
                                1 == a && b.removeAttribute("vspace"))
                              : 8 == a && (b.removeAttribute("vspace"), b.removeStyle("margin-top"), b.removeStyle("margin-bottom"));
                          },
                        },
                        {
                          id: "cmbAlign",
        ...
        },
        {
          ...
          elements: [
            ...
            { type: "fileButton", id: "uploadButton", filebrowser: "info:txtUrl", label: d.lang.image.btnUpload, for: ["Upload", "upload"] },
          ],
        },
        {
          id: "advanced",
