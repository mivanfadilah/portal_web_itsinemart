			       ...
			       <div class="carousel-item<?php if ($x == 1) {echo ' active';}?>">
			        ...
			        <div class="container" style="z-index: 1">
			          <div class="carousel-caption">
			            <h1><b>SELAMAT DATANG DI PORTAL</b></h1>
			            <h1><b>IT SINEMART</b></h1>
			          </div>
			        </div>
			      </div>
			    <?php endforeach;?>
...
<div class="marketing">
  <div class="container">
    ...
    <div class="row featurette">
      <div class="col-md-6">
        <img class="featurette-image img-fluid mx-auto" src="assets/images/sambutan/<?php echo $r['gambar'] ?>" alt="">
      </div>
      <div class="col-md-6">
        <h2 class="featurette-heading"><?php echo $r['judul'] ?></h2><br>
        <p style="text-align: justify;" class="lead"><?php echo limit_words($r['isi'], 85) . '...'; ?></p>
