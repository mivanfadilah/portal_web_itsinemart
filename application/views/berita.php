          ...
          <a href="<?php echo site_url('berita/vw-' . $row->slug); ?>">
            <div class="single-blog-post post-style-4 d-flex align-items-center">
              ...
              <div class="post-thumbnail">
                <img src="<?php echo base_url() . 'assets/images/' . $row->gambar; ?>" alt="" class="gabr">
              </div>
              <!-- Post Content -->
              <div class="post-content">
                ...
                <!-- Post Meta -->
                <div class="post-meta">
                  <p><i class="fa fa-user"></i> <?php echo $row->nama; ?> | <i class="fa fa-calendar"></i> <?php echo $row->tanggal; ?> | <i class="fa fa-tags"></i> <?php echo $row->kategori; ?></p>
                </div>
              </div>
            </div>
          </a>
