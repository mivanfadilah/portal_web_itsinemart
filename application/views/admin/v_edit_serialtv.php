...
$b = $data->row_array();
?>
        <form action="<?php echo base_url() . 'admin/serialtv/update_serialtv' ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="box-body">
            <div class="row">
              <div class="col-md-10">
                ...
                <input type="text" name="xjudul" class="form-control" value="<?php echo $b['judul']; ?>" placeholder="Judul serialtv atau artikel" required/>
              </div>
              <!-- /.col -->
              <div class="col-md-2">
          ...
          <div class="col-md-8">
            ...
            <div class="box box-danger">
              <div class="box-header">
                <h3 class="box-title">serialtv</h3>
              </div>
              <div class="box-body">
