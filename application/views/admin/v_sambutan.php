...
$b = $data->row_array();
?>
        <form action="<?php echo base_url() . 'admin/sambutan/update_sambutan' ?>" method="post" enctype="multipart/form-data">

          <!-- /.box-header -->
          <div class="box-body">
            <div class="row">
              <div class="col-md-10">
                <input type="text" name="xjudul" class="form-control" value="<?php echo $b['judul']; ?>" placeholder="Judul sambutan atau artikel" required/>
              </div>
              <!-- /.col -->
              <div class="col-md-2">
          ...
          <div class="col-md-4">
            <div class="box box-primary">
              ...
              <div class="box-body">
               <div class="form-group">
                <label>Gambar</label>
                <input type="hidden" value="<?php echo $b['gambar']; ?>" name="gambar">
...
<?php if ($this->session->flashdata('msg') == 'info'): ?>
  ...
  <?php elseif ($this->session->flashdata('msg') == 'info1'): ?>
   <script type="text/javascript">
    $.toast({
      heading: 'Info',
      text: "Sambutan berhasil di update tdengan gambar tetap",
      showHideTransition: 'slide',
      icon: 'info',
      hideAfter: false,
      position: 'bottom-right',
