...
<html lang="en">
<head>
  <title>Login IT Sinemart</title>
  <meta charset="UTF-8">
  <meta name="keyword" content="Komplek Ruko Plaza Kedoya Elok Blok DE 19-20 Jl. Panjang - Kedoya Jakarta 11520 -Indonesia">
  <meta name="description" content="Portal Resmi IT Sinemart">
    ...
    <div class="container-login100">
      <div class="wrap-login100">
        <div class="login100-form-title" style="background-image: url(<?php echo base_url() . 'assetss/images/bg-01.jpg' ?>);">
          <marquee><span  class="login100-form-title-1">
            Silahkan Login !!!
          </span></marquee>
        </div>
