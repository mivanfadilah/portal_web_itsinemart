...
$b = $data->row_array();
?>
          <form action="<?php echo base_url() . 'admin/tutorial/update_tutorial' ?>" method="post" enctype="multipart/form-data">
...
<?php if ($this->session->flashdata('msg') == 'info'): ?>
  <script type="text/javascript">
    $.toast({
      heading: 'Info',
      text: "tutorial berhasil di update",
  ...
  <?php elseif ($this->session->flashdata('msg') == 'info1'): ?>
   <script type="text/javascript">
     $.toast({
      heading: 'Info',
      text: "tutorial berhasil di update tdengan gambar tetap",
      showHideTransition: 'slide',
      icon: 'info',
      hideAfter: false,
      position: 'bottom-right',
