            ...
            <div class="box">
              ...
              <div class="box">
                <div class="box-header text-center">
                  <a class="btn btn-success btn-flat" href="<?php echo base_url() . 'admin/berita/add_berita' ?>"><span class="fa fa-plus-circle"></span>  Post Berita</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
	...
	?>
	                     <tr>
	                      ...
	                      <td style="text-align:right;">
	                        <a class="btn" href="<?php echo base_url() . 'admin/berita/get_edit/' . $id; ?>"><span class="fa fa-pencil"></span></a>
