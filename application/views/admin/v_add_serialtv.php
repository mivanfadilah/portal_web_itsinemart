   ...
   <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <form action="<?php echo base_url() . 'admin/serialtv/simpan_serialtv' ?>" method="post" enctype="multipart/form-data">

          <!-- /.box-header -->
          <div class="box-body">
            <div class="row">
              <div class="col-md-10">
                <input type="text" name="xjudul" class="form-control" placeholder="Judul serialtv atau artikel" required/>
              </div>
              <!-- /.col -->
              <div class="col-md-2">
          ...
          <div class="col-md-8">
            ...
            <div class="box box-danger">
              <div class="box-header">
                <h3 class="box-title">Serial TV</h3>
              </div>
              <div class="box-body">
