  ...
  return (function (e) {
    ...
    135: function (e, r, n) {
      ...
      t.datepickerLocale("fr", "fr", {
        ...
        t.locale("fr", { buttonText: { year: "Année", month: "Mois", week: "Semaine", day: "Jour", list: "Mon planning" }, allDayHtml: "Toute la<br/>journée", eventLimitText: "en plus", noEventsMessage: "Aucun événement à afficher" });
    },
    136: function (e, r, n) {
      !(function (e, r) {
        r(n(0));
