...
!(function (t, e) {
  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      function a(t, e, n) {
        ...
        l(t),
          ...
          n && ((e -= u), (r = Math.floor(e / o.length)), (i = Math.floor(e - r * (o.length - 1)))),
      ...
      function d(t, e) {
        var n,
          r = t.add(e);
        return r.css({ position: "relative", left: -1 }), (n = t.outerHeight() - e.outerHeight()), r.css({ position: "", left: "" }), n;
      }
      function c(t) {
      ...
      function g(t) {
        ...
        return (n = v(n)), (r = v(r)), (e = { left: 0, right: 0, top: 0, bottom: r }), y() && "rtl" === t.css("direction") ? (e.left = n) : (e.right = n), e;
      }
      function v(t) {
      ...
      function _(t) {
        var e,
          ...
          r = [],
          i = [];
        for ("string" == typeof t ? (i = t.split(/\s*,\s*/)) : "function" == typeof t ? (i = [t]) : ht.isArray(t) && (i = t), e = 0; e < i.length; e++)
          (n = i[e]), "string" == typeof n ? r.push("-" === n.charAt(0) ? { field: n.substring(1), order: -1 } : { field: n, order: 1 }) : "function" == typeof n && r.push({ func: n });
        return r;
      }
      function x(t, e, n, r, i) {
        var o, s;
        for (o = 0; o < n.length; o++) if ((s = O(t, e, n[o], r, i))) return s;
        return 0;
      }
          ...
          return (
            ...
            (t.prototype.intersect = function (e) {
              var n = this.startMs,
                ...
                i = null;
              return (
                null != e.startMs && (n = null == n ? e.startMs : Math.max(n, e.startMs)),
                null != e.endMs && (r = null == r ? e.endMs : Math.min(r, e.endMs)),
                (null == n || null == r || n < r) && ((i = new t(n, r)), (i.isStart = this.isStart && n === this.startMs), (i.isEnd = this.isEnd && r === this.endMs)),
                i
              );
            }),
      ...
      function i(t, e, n) {
        ...
        return (
          o.isMoment(p) || a.isNativeDate(p) || void 0 === p
            ...
            : ((r = !1),
              (i = !1),
              h ? (l.test(p) ? ((p += "-01"), (t = [p]), (r = !0), (i = !0)) : (d = u.exec(p)) && ((r = !d[5]), (i = !0))) : s.isArray(p) && (i = !0),
              (c = e || r ? o.utc.apply(o, t) : o.apply(null, t)),
              r ? ((c._ambigTime = !0), (c._ambigZone = !0)) : n && (i ? (c._ambigZone = !0) : h && c.utcOffset(p))),
          (c._fullCalendar = !0),
          c
        );
      }
          ...
          return (
            (t.parse = function (e, n) {
              ...
              return (
                ...
                !0 === l ? (s.stripTime(), a && a.stripTime()) : !1 === l && (s.hasTime() || s.time(0), a && !a.hasTime() && a.time(0)),
          ...
          return (
            ...
            (e.prototype.handleInteractionStart = function (e) {
              ...
              this.component.hitsNeeded(),
                ...
                e
                  ? ((r = { left: s.getEvX(e), top: s.getEvY(e) }),
                    (i = r),
                    o && ((n = s.getOuterRect(o)), (i = s.constrainPoint(i, n))),
                    (this.origHit = this.queryHit(i.left, i.top)),
                    o && this.options.subjectCenter && (this.origHit && (n = s.intersectRects(this.origHit, n) || n), (i = s.getRectCenter(n))),
    ...
    function (t, e, n) {
      Object.defineProperty(e, "__esModule", { value: !0 }), (e.version = "3.10.0"), (e.internalApiVersion = 12);
      var r = n(4);
        ...
        u = (function () {
          ...
          return (
            ...
            (t.prototype.unbind = function () {
              this.stopListeningTo(r(document)), window.removeEventListener("touchmove", this.handleTouchMoveProxy, { passive: !1 }), window.removeEventListener("scroll", this.handleScrollProxy, !0);
            }),
        ...
        o = (function () {
          ...
          return (
            ...
            (t.prototype.applyManualStandardProps = function (e) {
              return (
                null != e.id ? (this.id = t.normalizeId((this.rawId = e.id))) : (this.id = t.generateId()),
        ...
        l = (function () {
          ...
          return (
            ...
            (t.prototype.mutateSingle = function (t) {
              var e;
              return (
                this.dateMutation && ((e = t.dateProfile), (t.dateProfile = this.dateMutation.buildNewDateProfile(e, t.source.calendar))),
        ...
        o = (function () {
          ...
          return (
            (t.createFromDiff = function (e, n, i) {
              ...
              return (
                (s = o(n.start, e.start)),
                n.end && ((a = o(n.unzonedRange.getEnd(), e.unzonedRange.getEnd())), (l = a.subtract(s))),
                (u = new t()),
                (u.clearEnd = d),
                (u.forceTimed = c),
                (u.forceAllDay = p),
            ...
            (t.prototype.buildNewDateProfile = function (t, e) {
              var n = t.start.clone(),
                ...
                o = !1;
              return (
                t.end && !this.clearEnd ? (r = t.end.clone()) : this.endDelta && !r && (r = e.getDefaultEventEnd(t.isAllDay(), n)),
        ...
        p = (function (t) {
          ...
          return (
            ...
            (e.prototype.initRenderQueue = function () {
              (this.renderQueue = new a.default({ event: this.opt("eventRenderWait") })),
            ...
            (e.prototype.computeTitle = function (t) {
              var e;
              return (
                (e = /^(year|month)$/.test(t.currentRangeUnit) ? t.currentUnzonedRange : t.activeUnzonedRange),
                this.formatRange(
                  { start: this.calendar.msToMoment(e.startMs, t.isRangeAllDay), end: this.calendar.msToMoment(e.endMs, t.isRangeAllDay) },
                  t.isRangeAllDay,
            ...
            (e.prototype.triggerEventDrop = function (t, e, n, r, i) {
              this.publiclyTrigger("eventDrop", { context: r[0], args: [t.toLegacy(), e, n, i, {}, this] });
            }),
            ...
            (e.prototype.triggerExternalDrop = function (t, e, n, r, i) {
              this.publiclyTrigger("drop", { context: n[0], args: [t.dateProfile.start.clone(), r, i, this] }), e && this.publiclyTrigger("eventReceive", { context: this, args: [t.buildInstance().toLegacy(), this] });
            }),
            ...
            (e.prototype.triggerEventResize = function (t, e, n, r, i) {
              this.publiclyTrigger("eventResize", { context: r[0], args: [t.toLegacy(), e, n, i, {}, this] });
            }),
            ...
            (e.prototype.selectEventInstance = function (t) {
              (this.selectedEventInstance && this.selectedEventInstance === t) ||
        ...
        o = (function () {
          ...
          return (
            ...
            (t.prototype._getTimeText = function (t, e, n, r, i) {
              return null == r && (r = this.eventTimeFormat), null == i && (i = this.displayEventEnd), this.displayEventTime && !n ? (i && e ? this.view.formatRange({ start: t, end: e }, !1, r) : t.format(r)) : "";
            }),
            ...
            (e.prototype.buildInstances = function (t) {
              for (var e, n, r, i = this.source.calendar, o = t.getStart(), s = t.getEnd(), u = []; o.isBefore(s); )
                (this.dowHash && !this.dowHash[o.day()]) ||
                  ((e = i.applyTimezone(o)), (n = e.clone()), (r = null), this.startTime ? n.time(this.startTime) : n.stripTime(), this.endTime && (r = e.clone().time(this.endTime)), u.push(new a.default(this, new l.default(n, r, i)))),
                  o.add(1, "days");
              return u;
            }),
        ...
        s = (function () {
          ...
          return (
            ...
            (t.prototype.buildCurrentRangeInfo = function (t, e) {
              ...
              return (
                r.duration
                  ? ((o = r.duration), (s = r.durationUnit), (a = this.buildRangeFromDuration(t, e, o, s)))
                  : (n = this.opt("dayCount"))
                  ? ((s = "day"), (a = this.buildRangeFromDayCount(t, e, n)))
                  : (a = this.buildCustomVisibleRange(t))
                  ? (s = i.computeGreatestUnit(a.getStart(), a.getEnd()))
                  : ((o = this.getFallbackDuration()), (s = i.computeGreatestUnit(o)), (a = this.buildRangeFromDuration(t, e, o, s))),
            ...
            (t.prototype.buildRangeFromDuration = function (t, e, n, s) {
              ...
              return (
                h || ((l = this.opt("dateIncrement")), l ? ((u = r.duration(l)), (h = u < n ? i.computeDurationGreatestUnit(u, l) : s)) : (h = s)),
                n.as("days") <= 1 && this._view.isHiddenDay(d) && ((d = this._view.skipHiddenDays(d, e)), d.startOf("day")),
                a(),
                this.trimHiddenDays(p) || ((t = this._view.skipHiddenDays(t, e)), a()),
                p
              );
            }),
        ...
        a = (function () {
          ...
          return (
            (t.prototype.startInteraction = function (t, e) {
              ...
              this.isInteracting ||
                ((this.delay = i.firstDefined(e.delay, this.options.delay, 0)),
            ...
            (t.prototype.bindHandlers = function () {
              var t = s.default.get();
              this.isGeneric
                ? this.listenTo(r(document), { drag: this.handleMove, dragstop: this.endInteraction })
                : this.isTouch
                ? this.listenTo(t, { touchmove: this.handleTouchMove, touchend: this.endInteraction, scroll: this.handleTouchScroll })
                : this.listenTo(t, { mousemove: this.handleMouseMove, mouseup: this.endInteraction }),
        ...
        s = (function (t) {
          ...
          return (
            ...
            (e.prototype.updateDayTable = function () {
              for (
                var t, e, n, r = this, i = r.view, o = i.calendar, s = o.msToUtcMoment(r.dateProfile.renderUnzonedRange.startMs, !0), a = o.msToUtcMoment(r.dateProfile.renderUnzonedRange.endMs, !0), l = -1, u = [], d = [];
                s.isBefore(a);

              )
                i.isHiddenDay(s) ? u.push(l + 0.5) : (l++, u.push(l), d.push(s.clone())), s.add(1, "days");
            ...
            (e.prototype.sliceRangeByRow = function (t) {
              ...
              for (e = 0; e < this.rowCnt; e++)
                (n = e * s),
                  ...
                  (i = Math.ceil(i)),
                  (o = Math.floor(o)),
                  i <= o && d.push({ row: e, firstRowDayIndex: i - n, lastRowDayIndex: o - n, isStart: i === l, isEnd: o === u });
              return d;
            }),
            (e.prototype.sliceRangeByDay = function (t) {
              var e,
                ...
                c = [];
              for (e = 0; e < this.rowCnt; e++)
                for (n = e * a, r = n + a - 1, i = n; i <= r; i++)
                  (o = Math.max(u, i)), (s = Math.min(d, i)), (o = Math.ceil(o)), (s = Math.floor(s)), o <= s && c.push({ row: e, firstRowDayIndex: o - n, lastRowDayIndex: s - n, isStart: o === u, isEnd: s === d });
              return c;
            }),
            ...
            (e.prototype.renderHeadDateCellHtml = function (t, e, n) {
              ...
              return (
                (r = "function" == typeof o.opt("columnHeaderHtml") ? o.opt("columnHeaderHtml")(t) : "function" == typeof o.opt("columnHeaderText") ? i.htmlEscape(o.opt("columnHeaderText")(t)) : i.htmlEscape(t.format(o.colHeadFormat))),
                1 === o.rowCnt ? (l = l.concat(o.getDayClasses(t, !0))) : l.push("fc-" + i.dayIDs[t.day()]),
                '<th class="' +
                  l.join(" ") +
                  '"' +
                  (1 === (a && o.rowCnt) ? ' data-date="' + t.format("YYYY-MM-DD") + '"' : "") +
                  (e > 1 ? ' colspan="' + e + '"' : "") +
                  (n ? " " + n : "") +
                  ">" +
                  (a ? s.buildGotoAnchorHtml({ date: t, forceOff: o.rowCnt > 1 || 1 === o.colCnt }, r) : r) +
                  "</th>"
              );
            }),
          ...
          return (
            ...
            (e.prototype.handleMouseover = function (t, e) {
              i.default.get().shouldIgnoreMouse() ||
                ...
                this.component.publiclyTrigger("eventMouseover", { context: t.el[0], args: [t.footprint.getEventLegacy(), e, this.view] }));
            }),
            (e.prototype.handleMouseout = function (t, e) {
              this.mousedOverSeg &&
                ...
                this.component.publiclyTrigger("eventMouseout", { context: t.el[0], args: [t.footprint.getEventLegacy(), e || {}, this.view] }));
            }),
          ...
          return (
            ...
            (e.prototype.componentFootprintToSegs = function (t) {
              ...
              for (e = 0; e < r.length; e++)
                (n = r[e]), this.isRTL ? ((n.leftCol = this.daysPerRow - 1 - n.lastRowDayIndex), (n.rightCol = this.daysPerRow - 1 - n.firstRowDayIndex)) : ((n.leftCol = n.firstRowDayIndex), (n.rightCol = n.lastRowDayIndex));
              return r;
            }),
            ...
            (e.prototype.renderGrid = function () {
              ...
              for (
                this.el.html(o),
                  ...
                  this.rowCoordCache = new s.default({ els: this.rowEls, isVertical: !0 }),
                  this.colCoordCache = new s.default({ els: this.cellEls.slice(0, this.colCnt), isHorizontal: !0 }),
                  t = 0;
                t < r;
                t++
              )
                for (e = 0; e < i; e++) this.publiclyTrigger("dayRender", { context: n, args: [this.getCellDate(t, e), this.getCellEl(t, e), n] });
            }),
            (e.prototype.renderDayRowHtml = function (t, e) {
              ...
              return (
                ...
                '<div class="' +
                  ...
                  (this.getIsNumbersVisible() ? "<thead>" + this.renderNumberTrHtml(t) + "</thead>" : "") +
                  "</table></div></div>"
              );
            }),
            ...
            (e.prototype.renderNumberCellHtml = function (t) {
              ...
              return s || this.cellWeekNumbersVisible
                ? ((e = this.getDayClasses(t)),
                  ...
                  this.cellWeekNumbersVisible && t.day() === n && (i += r.buildGotoAnchorHtml({ date: t, type: "week" }, { class: "fc-week-number" }, t.format("w"))),
                  s && (i += r.buildGotoAnchorHtml(t, { class: "fc-day-number" }, t.format("D"))),
                  (i += "</td>"))
                : "<td/>";
            }),
            ...
            (e.prototype.computeRowLevelLimit = function (t) {
              ...
              for (n = 0; n < l.length; n++) if (((r = l.eq(n).removeClass("fc-limited")), (o = 0), r.find("> td > :first-child").each(e), r.position().top + o > a)) return n;
              return !1;
            }),
            (e.prototype.limitRow = function (t, e) {
              ...
              if (e && e < b.segLevels.length) {
                for (n = b.segLevels[e - 1], r = b.cellMatrix, o = b.tbodyEl.children().slice(e).addClass("fc-limited").get(), s = 0; s < n.length; s++) {
                  ...
                  if (u) {
                    for (c = r[e - 1][a.leftCol], p = c.attr("rowspan") || 1, h = [], f = 0; f < d.length; f++)
                      (g = i('<td class="fc-more-cell"/>').attr("rowspan", p)), (l = d[f]), (y = this.renderMoreLink(t, a.leftCol + f, [a].concat(l))), (v = i("<div/>").append(y)), g.append(v), h.push(g[0]), w.push(g[0]);
            ...
            (e.prototype.renderMoreLink = function (t, e, n) {
              ...
              return i('<a class="fc-more"/>')
                ...
                .on("click", function (s) {
                  ...
                  "function" == typeof a && (a = r.publiclyTrigger("eventLimitClick", { context: o, args: [{ date: l.clone(), dayEl: d, moreEl: u, segs: p, hiddenSegs: h }, s, o] })),
            ...
            (e.prototype.resliceDaySegs = function (t, e) {
              ...
              for (n = 0; n < t.length; n++)
                (r = t[n]),
                  (o = r.footprint.componentFootprint.unzonedRange.intersect(c)) &&
                    p.push(
                      i.extend({}, r, { footprint: new d.default(new u.default(o, r.footprint.componentFootprint.isAllDay), r.footprint.eventDef, r.footprint.eventInstance), isStart: r.isStart && o.isStart, isEnd: r.isEnd && o.isEnd })
                    );
        ...
        c = (function (t) {
          function e(e, n) {
            ...
            return (
              ...
              (r.scroller = new a.default({ overflowX: "hidden", overflowY: "auto" })),
              r
            );
          }
          return (
            ...
            (e.prototype.renderSkeletonHtml = function () {
              ...
              return (
                ...
                '">' +
                (this.opt("columnHeader") ? '<thead class="fc-head"><tr><td class="fc-head-container ' + t.getClass("widgetHeader") + '">&nbsp;</td></tr></thead>' : "") +
            ...
            (e.prototype.updateSize = function (e, n, r) {
              ...
              t.prototype.updateSize.call(this, e, n, r),
                ...
                a && "number" != typeof a && this.dayGrid.limitRows(a),
                n || (this.scroller.setHeight(i), (o = this.scroller.getScrollbarWidths()), (o.left || o.right) && (s.compensateScroll(l, o), (i = this.computeScrollerHeight(e)), this.scroller.setHeight(i)), this.scroller.lockOverflow(o));
            }),
        ...
        d = (function () {
          ...
          return (
            ...
            (t.prototype.isEventInstanceGroupAllowed = function (t) {
              ...
              for (e = 0; e < r.length; e++) if (!this.isFootprintAllowed(r[e].componentFootprint, s, a, l, r[e].eventInstance)) return !1;
              if (d) for (e = 0; e < r.length; e++) if (!1 === d(r[e].componentFootprint.toLegacy(this._calendar), r[e].getEventLegacy())) return !1;
              return !0;
            }),
            ...
            (t.prototype.constraintValToFootprints = function (t, e) {
              ...
              return "businessHours" === t
                ...
                : "object" == typeof t
                ? ((n = this.parseEventDefToInstances(t)), n ? this.eventInstancesToFootprints(n) : this.parseFootprints(t))
                : null != t
                ? ((n = this.eventManager.getEventInstancesWithId(t)), this.eventInstancesToFootprints(n))
                : void 0;
            }),
            ...
            (t.prototype.parseFootprints = function (t) {
              var e, n;
              return (
                t.start && ((e = this._calendar.moment(t.start)), e.isValid() || (e = null)),
                t.end && ((n = this._calendar.moment(t.end)), n.isValid() || (n = null)),
          ...
          return (
            ...
            (t.prototype.removeEventInstancesForDef = function (t) {
              var e,
                ...
                r = n[t.id];
              r &&
                ((e = i.removeMatching(r.eventInstances, function (e) {
                  return e.def === t;
                })),
    ...
    function (t, e, n) {
      ...
      (e.default = o),
        ...
        (o.prototype.iconClasses = { close: "fc-icon-x", prev: "fc-icon-left-single-arrow", next: "fc-icon-right-single-arrow", prevYear: "fc-icon-left-double-arrow", nextYear: "fc-icon-right-double-arrow" }),
    ...
    function (t, e, n) {
      ...
      (e.default = o),
        ...
        (o.prototype.iconClasses = { close: "ui-icon-closethick", prev: "ui-icon-circle-triangle-w", next: "ui-icon-circle-triangle-e", prevYear: "ui-icon-seek-prev", nextYear: "ui-icon-seek-next" }),
        ...
        s = (function () {
          ...
          return (
            ...
            (t.prototype.stop = function (t, e) {
              ...
              this.isFollowing &&
                !this.isAnimating &&
                ((this.isFollowing = !1), this.stopListeningTo(r(document)), t && i && !this.isHidden ? ((this.isAnimating = !0), this.el.animate({ top: this.top0, left: this.left0 }, { duration: i, complete: o })) : o());
            }),
          ...
          return (
            ...
            (t.prototype.position = function () {
              ...
              (o = a.top || 0),
                ...
                p.is(window) || p.is(document) ? ((p = c), (t = 0), (e = 0)) : ((n = p.offset()), (t = n.top), (e = n.left)),
                (t += c.scrollTop()),
                (e += c.scrollLeft()),
            ...
            (e.prototype.compoundTask = function (t) {
              ...
              if (t.namespace && "destroy" === t.type)
                for (e = r.length - 1; e >= 0; e--)
                  if (((n = r[e]), n.namespace === t.namespace))
                    switch (n.type) {
                      case "init":
                        i = !1;
                      case "add":
        ...
        p = (function (t) {
          ...
          return (
            ...
            (e.prototype.buildGotoAnchorHtml = function (t, e, n) {
              var r, i, s, u;
              return (
                o.isPlainObject(t) ? ((r = t.date), (i = t.type), (s = t.forceOff)) : (r = t),
                (r = l.default(r)),
                (u = { date: r.format("YYYY-MM-DD"), type: i || "day" }),
              ...
              return (
                this.dateProfile.activeUnzonedRange.containsDate(t)
                  ? (i.push("fc-" + a.dayIDs[t.day()]),
                    ...
                    (n = r.calendar.getNow()),
                    t.isSame(n, "day") ? (i.push("fc-today"), !0 !== e && i.push(r.calendar.theme.getClass("today"))) : t < n ? i.push("fc-past") : i.push("fc-future"))
            ...
            (e.prototype.computeDayRange = function (t) {
              var e = this._getCalendar(),
                ...
                i = +r.time(),
                o = r.clone().stripTime();
              return i && i >= this.nextDayThreshold && o.add(1, "days"), o <= n && (o = n.clone().add(1, "days")), { start: n, end: o };
            }),
          ...
          return (
            ...
            (t.prototype.destroy = function () {
              this.view && this.clearView(),
                ...
                this.el.off(".fc"),
                this.windowResizeProxy && (i(window).unbind("resize", this.windowResizeProxy), (this.windowResizeProxy = null)),
                u.default.unneeded();
            }),
            ...
            (t.prototype.renderView = function (t) {
              ...
              this.freezeContentHeight(),
                ...
                !this.view &&
                  t &&
                  ((e = this.view = this.viewsByType[t] || (this.viewsByType[t] = this.instantiateView(t))),
            ...
            (t.prototype.updateViewSize = function (t) {
              ...
              if (!this.ignoreUpdateViewSize && n)
                return t && (this.calcSize(), (e = n.queryScroll())), this.ignoreUpdateViewSize++, n.updateSize(this.getSuggestedViewHeight(), this.isHeightAuto(), t), this.ignoreUpdateViewSize--, t && n.applyScroll(e), !0;
            }),
            ...
            (t.prototype._calcSize = function () {
              ...
              this.suggestedViewHeight =
                "number" == typeof t
                  ...
                  : Math.round(this.contentEl.width() / Math.max(this.opt("aspectRatio"), 0.5));
            }),
              ...
              (this.defaultAllDayEventDuration = o.duration(this.opt("defaultAllDayEventDuration"))),
                ...
                this.optionsManager.watch("buildingMomentLocale", ["?locale", "?monthNames", "?monthNamesShort", "?dayNames", "?dayNamesShort", "?firstDay", "?weekNumberCalculation"], function (e) {
                  ...
                  e.monthNames && (o._months = e.monthNames),
                    ...
                    null == i && "ISO" === r && (i = 1),
                    null != i && ((n = Object.create(o._week)), (n.dow = i), (o._week = n)),
            ...
            (t.prototype.moment = function () {
              ...
              var n;
              return (
                "local" === this.opt("timezone") ? ((n = y.default.apply(null, t)), n.hasTime() && n.local()) : (n = "UTC" === this.opt("timezone") ? y.default.utc.apply(null, t) : y.default.parseZone.apply(null, t)),
    ...
    function (t, e, n) {
      function r(t) {
        ...
        return (
          ...
          e && ((e = "object" == typeof e ? o.extend({}, e) : {}), (n = e.start), null == n && (n = e.time), (r = e.duration), (i = e.stick), delete e.start, delete e.time, delete e.duration, delete e.stick),
        ...
        v = (function (t) {
          ...
          return (
            ...
            (e.prototype.listenToExternalDrag = function (t, e, n) {
              ...
              (this.dragListener = new c.default(s, {
                ...
                hitOver: function (t) {
                  ...
                  r ? ((i = o.computeExternalDrop(r, u)), i ? ((e = new h.default(i.buildInstances())), (n = u.eventProps ? s.isEventInstanceGroupAllowed(e) : s.isExternalInstanceGroupAllowed(e))) : (n = !1)) : (n = !1),
            ...
            (e.prototype.computeExternalDrop = function (t, e) {
              ...
              return (
                t.isAllDay && (e.startTime ? i.time(e.startTime) : i.stripTime()),
                e.duration && (n = i.clone().add(e.duration)),
                (i = r.applyTimezone(i)),
                n && (n = r.applyTimezone(n)),
                p.default.parse(o.extend({}, e.eventProps, { start: i, end: n }), new f.default(r))
              );
            }),
            e
          );
            ...
            (e.prototype.buildDragListener = function (t, e) {
              ...
              return (this.dragListener = new l.default(s, {
                ...
                hitOver: function (n, l, c) {
                  ...
                  g && v
                    ? ((r = e ? i.computeEventStartResizeMutation(g, v, t.footprint) : i.computeEventEndResizeMutation(g, v, t.footprint)),
                      r ? ((h = d.buildMutatedEventInstanceGroup(p.id, r)), (f = s.isEventInstanceGroupAllowed(h))) : (f = !1))
                    : (f = !1),
          ...
          return (
            ...
            (e.prototype.buildDragListener = function (t) {
              ...
              var g = (this.dragListener = new l.default(a, {
                ...
                interactionStart: function (r) {
                  (t.component = s),
                    (e = !1),
                    (n = new u.default(t.el, { additionalClass: "fc-dragging", parentEl: a.el, opacity: g.isTouch ? null : o.opt("dragOpacity"), revertDuration: o.opt("dragRevertDuration"), zIndex: 2 })),
                    n.hide(),
                    n.start(r);
                },
                ...
                hitOver: function (e, l, u) {
                  ...
                  t.hit && (u = t.hit),
                    ...
                    p && f ? ((r = o.computeEventDropMutation(p, f, h)), r ? ((v = c.buildMutatedEventInstanceGroup(h.id, r)), (y = s.isEventInstanceGroupAllowed(v))) : (y = !1)) : (y = !1),
            ...
            (e.prototype.computeEventDateMutation = function (t, e) {
              var n,
                ...
                u = !1;
              return (
                t.isAllDay !== e.isAllDay && ((a = !0), e.isAllDay ? ((u = !0), i.stripTime()) : (l = !0)),
        ...
        f = (function (t) {
          function e(e, n) {
            ...
            return (
              ...
              (r.scroller = new d.default({ overflowX: "hidden", overflowY: "auto" })),
              r
            );
          }
          return (
            ...
            (e.prototype.renderSkeletonHtml = function () {
              ...
              return (
                ...
                t.getClass("widgetContent") +
                '">' +
                (this.dayGrid ? '<div class="fc-day-grid"/><hr class="fc-divider ' + t.getClass("widgetHeader") + '"/>' : "") +
                "</td></tr></tbody></table>"
              );
            }),
            ...
            (e.prototype.updateSize = function (e, n, r) {
              ...
              this.timeGrid.bottomRuleEl.hide(),
                ...
                this.dayGrid && (this.dayGrid.removeSegPopover(), (i = this.opt("eventLimit")), i && "number" != typeof i && (i = 5), i && this.dayGrid.limitRows(i)),
                n ||
                  ((o = this.computeScrollerHeight(e)),
                  this.scroller.setHeight(o),
                  (s = this.scroller.getScrollbarWidths()),
                  (s.left || s.right) && (u.compensateScroll(a, s), (o = this.computeScrollerHeight(e)), this.scroller.setHeight(o)),
          ...
          renderHeadIntroHtml: function () {
            ...
            return this.opt("weekNumbers")
              ? ((t = r.format(this.opt("smallWeekFormat"))),
                '<th class="fc-axis fc-week-number ' + n.theme.getClass("widgetHeader") + '" ' + e.axisStyleAttr() + ">" + e.buildGotoAnchorHtml({ date: r, type: "week", forceOff: this.colCnt > 1 }, u.htmlEscape(t)) + "</th>")
              : '<th class="fc-axis ' + n.theme.getClass("widgetHeader") + '" ' + e.axisStyleAttr() + "></th>";
          },
          ...
          return (
            ...
            (e.prototype.sliceRangeByTimes = function (t) {
              var e,
                n,
                r = [];
              for (n = 0; n < this.daysPerRow; n++) (e = t.intersect(this.dayRanges[n])) && r.push({ startMs: e.startMs, endMs: e.endMs, isStart: e.isStart, isEnd: e.isEnd, dayIndex: n });
              return r;
            }),
            ...
            (e.prototype.renderSlats = function () {
              ...
              (this.slatContainerEl = this.el.find("> .fc-slats").html('<table class="' + t.getClass("tableGrid") + '">' + this.renderSlatRowHtml() + "</table>")),
                ...
                (this.slatCoordCache = new c.default({ els: this.slatEls, isVertical: !0 }));
            }),
            ...
            (e.prototype.renderColumns = function () {
              ...
              (this.dayRanges = this.dayDates.map(function (e) {
                ...
                (this.colCoordCache = new c.default({ els: this.colEls, isHorizontal: !0 })),
              ...
              if (r.isLeftInBounds(t) && i.isTopInBounds(e)) {
                ...
                if (null != o && null != s) {
                  var a = i.getTopOffset(s),
                    ...
                    p = a + (d / n) * l,
                    h = a + ((d + 1) / n) * l;
                  return { col: o, snap: c, component: this, left: r.getLeftOffset(o), right: r.getRightOffset(o), top: p, bottom: h };
                }
              }
            }),
            (e.prototype.getHitFootprint = function (t) {
    ...
    function (t, e, n) {
      ...
      function i(t) {
        var e, n, r, i, o;
        for (e = 0; e < t.length; e++) for (n = t[e], r = 0; r < n.length; r++) for (i = n[r], i.forwardSegs = [], o = e + 1; o < t.length; o++) s(i, t[o], i.forwardSegs);
      }
      function o(t) {
        var e,
          n,
          ...
          return (
            ...
            (e.prototype.fgSegHtml = function (t, e) {
              ...
              return (
                ...
                (n ? '<div class="fc-time" data-start="' + u.htmlEscape(i) + '" data-full="' + u.htmlEscape(r) + '"><span>' + u.htmlEscape(n) + "</span></div>" : "") +
                (d.title ? '<div class="fc-title">' + u.htmlEscape(d.title) + "</div>" : "") +
                '</div><div class="fc-bg"/>' +
            ...
            (e.prototype.computeFgSegForwardBack = function (t, e, n) {
              ...
              if (void 0 === t.forwardCoord)
                for (
                  i.length ? (this.sortForwardSegs(i), this.computeFgSegForwardBack(i[0], e + 1, n), (t.forwardCoord = i[0].backwardCoord)) : (t.forwardCoord = 1), t.backwardCoord = t.forwardCoord - (t.forwardCoord - n) / (e + 1), r = 0;
                  r < i.length;
                  r++
                )
          ...
          return (
            ...
            (e.prototype.renderSegs = function (t, e) {
              var n,
                ...
                o,
                s = [];
              for (this.eventRenderer.renderFgSegsIntoContainers(t, this.component.helperContainerEls), n = 0; n < t.length; n++)
                (r = t[n]), e && e.col === r.col && ((o = e.el), r.el.css({ left: o.css("left"), right: o.css("right"), "margin-left": o.css("margin-left"), "margin-right": o.css("margin-right") })), s.push(r.el[0]);
              return i(s);
            }),
            e
          );
          ...
          return (
            ...
            (e.prototype.attachSegEls = function (t, e) {
              var n,
                r = this.component;
              return (
                "bgEvent" === t ? (n = r.bgContainerEls) : "businessHours" === t ? (n = r.businessContainerEls) : "highlight" === t && (n = r.highlightContainerEls),
    ...
    function (t, e, n) {
      function r(t, e) {
        var n, r;
        for (n = 0; n < e.length; n++) if (((r = e[n]), r.leftCol <= t.rightCol && r.rightCol >= t.leftCol)) return !0;
        return !1;
      }
      function i(t, e) {
              ...
              for (r = 0; r < h; r++) {
                if (((i = p[r]), (o = 0), (a = s("<tr/>")), g.push([]), v.push([]), y.push([]), i))
                  for (l = 0; l < i.length; l++) {
                    for (u = i[l], n(u.leftCol), d = s('<td class="fc-event-container"/>').append(u.el), u.leftCol !== u.rightCol ? d.attr("colspan", u.rightCol - u.leftCol + 1) : (y[r][o] = d); o <= u.rightCol; )
                      (v[r][o] = d), (g[r][o] = u), o++;
                    a.append(d);
                  }
            ...
            (e.prototype.renderSegs = function (t, e) {
              ...
              return (
                ...
                this.component.rowEls.each(function (t, o) {
                  ...
                  e && e.row === t ? (a = e.el.position().top) : ((s = l.find(".fc-content-skeleton tbody")), s.length || (s = l.find(".fc-content-skeleton table")), (a = s.position().top)),
    ...
    function (t, e, n) {
      ...
      var r = n(2),
        ...
        c = (function (t) {
          function e(e, n) {
            var r = t.call(this, e, n) || this;
            return (r.segSelector = ".fc-list-item"), (r.scroller = new l.default({ overflowX: "hidden", overflowY: "auto" })), r;
          }
          return (
            r.__extends(e, t),
            (e.prototype.renderSkeleton = function () {
            ...
            (e.prototype.renderDates = function (t) {
              for (var e = this.calendar, n = e.msToUtcMoment(t.renderUnzonedRange.startMs, !0), r = e.msToUtcMoment(t.renderUnzonedRange.endMs, !0), i = [], o = []; n < r; )
                i.push(n.clone()), o.push(new s.default(n, n.clone().add(1, "day"))), n.add(1, "day");
            ...
            (e.prototype.componentFootprintToSegs = function (t) {
              ...
              for (e = 0; e < i.length; e++)
                if (
                  ...
                  ((r = { startMs: n.startMs, endMs: n.endMs, isStart: n.isStart, isEnd: n.isEnd, dayIndex: e }), o.push(r), !r.isEnd && !t.isAllDay && e + 1 < i.length && t.unzonedRange.endMs < i[e + 1].startMs + this.nextDayThreshold)
                ) {
            ...
            (e.prototype.dayHeaderHtml = function (t) {
              ...
              return (
                ...
                '" colspan="3">' +
                (e ? this.buildGotoAnchorHtml(t, { class: "fc-list-heading-main" }, o.htmlEscape(t.format(e))) : "") +
                (n ? this.buildGotoAnchorHtml(t, { class: "fc-list-heading-alt" }, o.htmlEscape(t.format(n))) : "") +
                "</td></tr>"
              );
            }),
            e
            ...
            (e.prototype.fgSegHtml = function (t) {
              ...
              return (
                (e = l.isAllDay
                  ...
                  ? t.isStart || t.isEnd
                    ? i.htmlEscape(this._getTimeText(r.msToMoment(t.startMs), r.msToMoment(t.endMs), l.isAllDay))
                    : n.getAllDayHtml()
                ...
                '<tr class="' +
                  d.join(" ") +
                  '">' +
                  (this.displayEventTime ? '<td class="fc-list-item-time ' + o.getClass("widgetContent") + '">' + (e || "") + "</td>" : "") +
            ...
            this.each(function (i, a) {
              ...
              "string" == typeof t
                ? "getCalendar" === t
                  ...
                  : d
                  ? r.isFunction(d[t])
                    ? ((l = d[t].apply(d, e)), i || (n = l), "destroy" === t && u.removeData("fullCalendar"))
                    : o.warn("'" + t + "' is an unknown FullCalendar method.")
                  : o.warn("Attempting to call a FullCalendar method on an element with no calendar.")
                : d || ((d = new s.default(u, t)), u.data("fullCalendar", d), d.render());
            }),
            n
          );
        }),
          ...
          return (
            ...
            (t.prototype.render = function () {
              var t = this.toolbarOptions.layout,
                e = this.el;
              t
                ? (e ? e.empty() : (e = this.el = r("<div class='fc-toolbar " + this.toolbarOptions.extraClasses + "'/>")),
                  e.append(this.renderSection("left")).append(this.renderSection("right")).append(this.renderSection("center")).append('<div class="fc-clear"/>'))
                : this.removeElement();
            }),
            (t.prototype.removeElement = function () {
              this.el && (this.el.remove(), (this.el = null));
                      ...
                      "title" === s
                        ...
                        : ((l = d[s])
                            ? ((g = function (t) {
                              ...
                              (v = o.getCustomButtonIconClass(l)) || (v = o.getIconClass(s)) || (y = l.text))
                            : (u = a.getViewSpec(s))
                            ? (e.viewsWithButtons.push(s),
                              (g = function () {
                                n.changeView(s);
                              }),
                              (y = u.buttonTextOverride) || (v = o.getIconClass(s)) || (y = u.buttonTextDefault))
                            : n[s] &&
                              ((g = function () {
                                n[s]();
                              }),
                          ...
                          g &&
                            ((b = ["fc-" + s + "-button", o.getClass("button"), o.getClass("stateDefault")]),
                            y ? ((m = i.htmlEscape(y)), (D = "")) : v && ((m = "<span class='" + v + "'></span>"), (D = ' aria-label="' + s + '"')),
                            (w = r('<button type="button" class="' + b.join(" ") + '"' + D + ">" + m + "</button>")
                              .click(function (t) {
          ...
          return (
            ...
            (e.prototype.compute = function () {
              ...
              (t = o.firstDefined(this.dynamicOverrides.locale, this.overrides.locale)),
                ...
                e || ((t = s.globalDefaults.locale), (e = a.localeOptionHash[t] || {})),
          ...
          return (
            ...
            (t.prototype.buildViewSpec = function (t) {
              ...
              return (
                ...
                (e.type = t),
                !!e.class &&
                  ((i = i || this.optionsManager.dynamicOverrides.duration || this.optionsManager.overrides.duration),
                  i && ((l = r.duration(i)), l.valueOf() && ((u = s.computeDurationGreatestUnit(l, i)), (e.duration = l), (e.durationUnit = u), 1 === l.as(u) && ((e.singleUnit = u), h.unshift(d[u] || {})))),
    ...
    function (t, e, n) {
      ...
      (e.default = o),
        ...
        (o.prototype.iconClasses = { close: "glyphicon-remove", prev: "glyphicon-chevron-left", next: "glyphicon-chevron-right", prevYear: "glyphicon-backward", nextYear: "glyphicon-forward" }),
    ...
    function (t, e, n) {
      ...
      (e.default = o),
        ...
        (o.prototype.iconClasses = { close: "fa-times", prev: "fa-chevron-left", next: "fa-chevron-right", prevYear: "fa-angle-double-left", nextYear: "fa-angle-double-right" }),
    ...
    function (t, e, n) {
      ...
      r.defineView("basic", { class: i.default }),
        r.defineView("basicDay", { type: "basic", duration: { days: 1 } }),
        r.defineView("basicWeek", { type: "basic", duration: { weeks: 1 } }),
    ...
    function (t, e, n) {
      ...
      var r = n(24),
        i = n(238);
      r.defineView("agenda", { class: i.default, defaults: { allDaySlot: !0, slotDuration: "00:30:00", slotEventOverlap: !0 } }),
        r.defineView("agendaDay", { type: "agenda", duration: { days: 1 } }),
    ...
    function (t, e, n) {
      ...
      var r = n(24),
        i = n(248);
      r.defineView("list", { class: i.default, buttonTextKey: "list", defaults: { buttonText: "list", listDayFormat: "LL", noEventsMessage: "No events to display" } }),
        r.defineView("listDay", { type: "list", duration: { days: 1 }, defaults: { listDayFormat: "dddd" } }),
        r.defineView("listWeek", { type: "list", duration: { weeks: 1 }, defaults: { listDayFormat: "dddd", listDayAltFormat: "LL" } }),
        r.defineView("listMonth", { type: "list", duration: { month: 1 }, defaults: { listDayAltFormat: "dddd" } }),
        r.defineView("listYear", { type: "list", duration: { year: 1 }, defaults: { listDayAltFormat: "dddd" } });
    },
    function (t, e) {
      Object.defineProperty(e, "__esModule", { value: !0 });
    },
