...
!(function (e, t) {
  "object" == typeof exports && "object" == typeof module
    ? (module.exports = t(require("fullcalendar"), require("jquery")))
    : "function" == typeof define && define.amd
    ? define(["fullcalendar", "jquery"], t)
    : "object" == typeof exports
    ? t(require("fullcalendar"), require("jquery"))
    : t(e.FullCalendar, e.jQuery);
    ...
    271: function (e, t, r) {
      function o(e) {
        ...
        return /^[^\/]+@([^\/\.]+\.)*(google|googlemail|gmail)\.com$/.test(e)
          ? e
          : (t = /^https:\/\/www.googleapis.com\/calendar\/v3\/calendars\/([^\/]*)/.exec(e)) || (t = /^https?:\/\/www.google.com\/calendar\/feeds\/([^\/]*)/.exec(e))
        ...
        u = (function (e) {
          ...
          return (
            ...
            (t.prototype.fetch = function (e, t, r) {
              ...
              return a
                ? (this.calendar.pushLoading(),
                  i.Promise.construct(function (e, t) {
                    l.ajax(
                      l.extend({}, i.JsonFeedEventSource.AJAX_DEFAULTS, u, {
                        url: n,
                        data: a,
                        success: function (r, n, u) {
                          var c, p;
                          o.calendar.popLoading(),
                            r.error
                              ? (o.reportError("Google Calendar API: " + r.error.message, r.error.errors), t())
                              : r.items && ((c = o.gcalItemsToRawEventDefs(r.items, a.timeZone)), (p = i.applyAll(s, o, [r, n, u])), l.isArray(p) && (c = p), e(o.parseEventDefs(c)));
                        },
            ...
            (t.prototype.gcalItemToRawEventDef = function (e, t) {
              ...
              var o = {};
              return (
                "object" == typeof e.extendedProperties && "object" == typeof e.extendedProperties.shared && (o = e.extendedProperties.shared),
                { id: e.id, title: e.summary, start: e.start.dateTime || e.start.date, end: e.end.dateTime || e.end.date, url: r, location: e.location, description: e.description, extendedProperties: o }
              );
            }),
            ...
            (t.prototype.buildRequestParams = function (e, t, r) {
              var o,
                n = this.googleCalendarApiKey || this.calendar.opt("googleCalendarApiKey");
              return n
                ? (e.hasZone() || (e = e.clone().utc().add(-1, "day")),
                  t.hasZone() || (t = t.clone().utc().add(1, "day")),
                  (o = l.extend(this.ajaxSettings.data || {}, { key: n, timeMin: e.format(), timeMax: t.format(), singleEvents: !0, maxResults: 9999 })),
                  r && "local" !== r && (o.timeZone = r.replace(" ", "_")),
                  o)
                : (this.reportError("Specify a googleCalendarApiKey. See http://fullcalendar.io/docs/google_calendar/"), null);
            }),
            ...
            (t.API_BASE = "https://www.googleapis.com/calendar/v3/calendars"),
            t
          );
        })(i.EventSource);
      (t.default = u), u.defineStandardProps({ url: !1, googleCalendarId: !1, googleCalendarApiKey: !0, googleCalendarError: !0 });
    },
    3: function (e, r) {
      e.exports = t;
    },
